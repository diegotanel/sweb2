class AsistTec < ActiveRecord::Base
  ...
  has_many :integrantes_asist_tec
  ...
  validates :anio_inicio, presence: true, unless: :saltear_validaciones_de_presencia
  validates :num_registro, presence: true, unless: :saltear_validaciones_de_presencia
  validates :num_registro, numericality: { only_integer: true }
